...
class CollectionController {
  async create(req, res, next) {
    try {
      ...
      const collection = await Collection.create({name, description, theme, img, 
        numberField1, numberField2, numberField3,
        stringField1, stringField2, stringField3,
        textField1, textField2, textField3,
        booleanField1, booleanField2, booleanField3,
  ...
  async getAllForUser(req, res) {
    ...
    const collections = await Collection.findAndCountAll({where: {userId}, order: ['id'], limit, offset});
  ...
  async edit(req, res) {
    ...
    const result = await Collection.update({name, description, theme, img, 
      numberField1, numberField2, numberField3,
      stringField1, stringField2, stringField3,
      textField1, textField2, textField3,
      booleanField1, booleanField2, booleanField3,
